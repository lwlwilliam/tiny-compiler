...
final class Op
{
    ...
    public const JMP = 40;             // 跳转。操作数: addr
    public const JMP_IF_FALSE = 41;    // 如果为 false，则跳转。操作数: addr

    public const CALL_NAME = 50;       // 调用。操作数: nameConstIndex, argc
    public const RET = 51; // 返回
